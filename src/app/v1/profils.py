...
@bp_v1.route('/profils', methods=['GET'])
def get_profils():
...
@bp_v1.route('/profils/<int:profil_id>', methods=['GET'])
...
@bp_v1.route('/profils/<int:profil_id>', methods=['PUT'])
...
@bp_v1.route('/profils/<int:profil_id>', methods=['DELETE'])
...
@bp_v1.route('/profils', methods=['POST'])
def add_profil():
    """Ajouter un profil"""
    data = request.get_json()
    if not data or not data.get('name') or not data.get('description'):
